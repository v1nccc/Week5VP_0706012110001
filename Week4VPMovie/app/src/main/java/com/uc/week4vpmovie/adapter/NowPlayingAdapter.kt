package com.uc.week4vpmovie.adapte
...
import com.uc.week4vpmovie.view.MovieDetail


class NowPlayingAdapter(private val dataSet: ArrayList<com.uc.week4vpmovie.model.Result>) :
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        init {
            ...
            cvNowPlaying = view.findViewById(R.id.card_now_playing)
        }
    }
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view = LayoutInflater.from(viewGroup.context)
            .inflate(R.layout.now_playing_card, viewGroup, false)
